...
if __name__ == '__main__':
    ...
    images_aug = os.path.join(DATA_PATH, 'images_aug')
    masks_aug = os.path.join(DATA_PATH, 'masks_aug')
    ...
    for i, img in enumerate(images_list):
        ...
        for j in range(AUG_VALUE+1):
            aug_image, aug_mask = aug_generator(image, mask, seed=i+j, stain_norm=None)
